...
public interface PeerInt extends Remote {
    ...
    void invalidate(Pair<String, Integer> messageId, String serverID, String fileName, int version)throws RemoteException;
    boolean poll(String fileName, int version)throws RemoteException;
}
